---
domain: concepts
topic: "OAuth and Auth Profiles: Multi-Credential Configuration, Provider Auth, and Profile Selection"
type: concept
keywords:
  - OAuth
  - auth profiles
...
related:
  ...
  - gateway/secrets
source: concepts/oauth.md
---

OAuth and auth profiles manage credentials for AI providers. Auth profiles allow multiple credential sets (e.g., different API keys or OAuth sessions) to be configured and selected per-agent.

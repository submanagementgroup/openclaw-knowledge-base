---
domain: concepts
topic: "Message Handling: Inbound Routing, Reply Delivery, Attachments, and Message Format"
type: concept
keywords:
  - messages
  - message routing
...
related:
  ...
  - concepts/agent-loop
source: concepts/messages.md
---

Message handling in OpenClaw: how inbound messages are routed, processed, and how replies are delivered. Includes message format, attachments, and delivery options.
...
The exact silent token `NO_REPLY` / `no_reply`

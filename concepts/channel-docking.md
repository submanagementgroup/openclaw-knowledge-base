---
domain: concepts
topic: "Channel Docking: Session-Channel Binding for Agent-Initiated Messages"
type: concept
keywords:
  - channel docking
  - session binding
...
related:
  - concepts/session
  - concepts/messages
source: concepts/channel-docking.md
---

Channel docking associates a session with a specific channel target, so the agent can initiate messages back to the channel outside of a turn.

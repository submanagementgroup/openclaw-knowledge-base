---
domain: concepts
topic: "Retry and Error Handling: Model Retries, Network Failures, and Compaction Retries"
type: concept
keywords:
  - retry
  - error handling
...
related:
  ...
  - concepts/compaction
source: concepts/retry.md
---

OpenClaw retry behavior for model errors, network failures, and tool failures.
...
```json5
{
  agents: {
    defaults: {
      // retry configuration lives in the provider config
    }
  },
  models: {
    providers: {

---
domain: concepts
topic: "Commitments: Inferred Short-Lived Follow-Up Memories, Heartbeat Delivery"
type: concept
keywords:
  - commitments
  - follow-up memory
...
source: concepts/commitments.md
---

Commitments are short-lived follow-up memories for time-scoped items (like "check in after the interview"). They are inferred automatically and delivered via heartbeat.
...
- [Configuration reference](/gateway/con

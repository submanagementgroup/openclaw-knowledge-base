---
domain: concepts
topic: "Soul: Agent Personality and Persona"
type: concept
keywords:
  - soul
  - persona
...
**Agent workspace:** Workspace files OpenClaw injects into the system prompt.
  

**System prompt:** How `SOUL.md` is composed into the per-turn system prompt.
  

**SOUL.md template:** Starter template for a personality file.

---
domain: concepts
topic: "TypeBox Schema Validation: Configuration Schemas, Plugin Manifest Validation"
type: reference
keywords:
  - TypeBox
  - schema validation
...
source: concepts/typebox.md
---

OpenClaw uses TypeBox for runtime schema validation of configuration, API inputs, and plugin manifests. Understanding TypeBox helps when building plugins or interpreting validation errors.

---
domain: concepts
topic: "Network Architecture: Gateway Surfaces, Pairing, Discovery, and Security"
type: concept
keywords:
  - network
  ...
  - network pairing
related:
  - gateway/network-discovery
  - gateway/remote-access
  - gateway/security-overview
source: network.md
---

OpenClaw network architecture overview: gateway surfaces, pairing, discovery, and security.

---
domain: concepts
topic: "Context Window and Context Management"
type: concept
keywords:
  - context
  - context window
...
**Context engine:** Custom context injection via plugins.
  

**Compaction:** Summarizing long conversations to keep them inside the model window.
  

**System prompt:** How the system prompt is built and what it injects each turn.
  

**Agent loop:** The full agent execution cycle from inbound message to final reply.

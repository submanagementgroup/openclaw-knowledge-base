---
domain: concepts
topic: "Markdown Formatting: Channel-Aware Rendering, Rich Output, and Message Formatting"
type: concept
keywords:
  - markdown formatting
  - message formatting
...
related:
  - concepts/messages
  - concepts/streaming
source: concepts/markdown-formatting.md
---

How OpenClaw renders and formats Markdown in agent replies. Channel-aware formatting ensures responses look good in each platform.
...
4. **Wire adapter:** update the channel outbound adapter to use the new chunker
   and renderer.
5. **Test:** add or update format tests and an outbound delivery te

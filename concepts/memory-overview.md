---
domain: concepts
topic: "Memory Overview: MEMORY.md, Daily Notes, memory_search, and memory_get Tools"
type: concept
keywords:
  - memory
  - MEMORY.md
...
OpenClaw memory system: agents remember things by writing plain Markdown files to the workspace. The `memory_search` and `memory_get` tools retrieve relevant content from these files.
...
- [Memory Wiki](/plugins/memory-wiki): co

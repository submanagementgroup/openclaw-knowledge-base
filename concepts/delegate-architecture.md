---
domain: concepts
topic: "Delegate Architecture: External Agent Processes and Runtime Routing"
type: concept
keywords:
...
The delegate architecture allows OpenClaw to route agent turns to external agent processes. This enables running multiple different agent runtimes alongside or instead of the embedded Pi agent.

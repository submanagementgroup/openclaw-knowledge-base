---
domain: concepts
topic: "Response Streaming: Real-Time Assistant Deltas, Block Replies, and Channel Streaming Behavior"
type: concept
keywords:
  - streaming
  - assistant streaming
...
OpenClaw streams assistant responses in real time as the model generates them. Streaming behavior differs by channel — some channels show typing indicators or progressive updates.
...
- Native and draft preview streaming suppress block replies for that turn, so a Slack reply is str

...
topic: "Logging Guide: File Logs, Console Output, Log Levels, and CLI Tailing"
type: procedure
keywords:
  - logging
  - log files
...
OpenClaw logging: file logs, console output, CLI tailing, and the Control UI Logs tab.
...
- `logging.redactPatterns`: list of regex strings to override the default set. Custom patterns apply on top of the built-

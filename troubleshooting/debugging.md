...
> **Note:** If a non-dev gateway is already running (launchd or systemd), stop it first:
...
The default **Rebuild and Debug Gateway** configuration is batteries-included, it will automatically delete the `/dist` folder and rebuild the p
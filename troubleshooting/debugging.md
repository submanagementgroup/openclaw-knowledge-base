...
topic: "Debugging Guide: Log Levels, Trace Mode, Diagnostic Commands, and Issue Reporting"
type: procedure
keywords:
  - debugging
  - debug guide
...
source: help/debugging.md
---

How to debug OpenClaw issues: log levels, trace mode, diagnostic commands, and issue reporting.
...
The tmux wrapper carries common non-secret runtime selectors su

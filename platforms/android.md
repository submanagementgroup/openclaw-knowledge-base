...
```bash
openclaw nodes invoke --node "" --command canvas.navigate --params '{"url":"http://<gateway-hostname>.local:18789/__openclaw__/canvas/"}'
```
...
> **Note:** App Actions availability depends on the device, Google Play Services version,

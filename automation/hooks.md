---
domain: automation
topic: "Hooks: Event-Driven Scripts for Commands and Agent Lifecycle Events"
type: procedure
keywords:
  - hooks
  - event hooks
...
Hooks are event-driven scripts that run when something happens in the Gateway. Available events include /new, /reset, /stop, and agent lifecycle events.
...
| bootstrap-extra-files | `agent:bootstrap`              | Injects additional

---
domain: install
topic: "Ansible Deployment"
type: procedure
keywords:
  - Ansible
  - ansible install
  - automation deploy
source: install/ansible.md
---
...
> **Note:** The [openclaw-ansible](https://github.com/openclaw/openclaw-ansible) repo is the source of truth for Ansible deployment. This page is a quick overview.
...
> **Note:** The gateway runs directly on the host (not in Docker). Agent sandboxing is

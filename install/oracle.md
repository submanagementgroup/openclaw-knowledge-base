---
domain: install
topic: "Oracle Cloud Installation"
type: procedure
keywords:
  - Oracle
  - OCI
  - oracle install
source: install/oracle.md
---
...
1. Log into [Oracle Cloud Console](https://cloud.oracle.com/).
    ...
    > **Note:** If instance creation fails with "Out of capacity", try a different availability domain or retry later. Free tier capacity is limited.

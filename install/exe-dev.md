---
domain: install
topic: "Executable Development Setup"
type: procedure
keywords:
  - exe development
  - dev setup
...
> **Note:** Keep this VM **stateful**. OpenClaw stores `openclaw.json`, per-agent `auth-profiles.json`, sessions, and channel/provider state under `~/.openclaw/`, plus the workspace under `~/.openclaw/workspace/`.

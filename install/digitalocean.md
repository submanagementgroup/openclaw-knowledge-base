---
domain: install
topic: "DigitalOcean Installation"
type: procedure
keywords:
  - DigitalOcean
  - droplet
  - DO install
source: install/digitalocean.md
---
...
> **Note:** Use a clean base image (Ubuntu 24.04 LTS). Avoid third-party Marketplace 1-click images unless you have reviewed their startup scripts and firewall defaults.

---
domain: cli
topic: "CLI Commands: completion, configure, crestodian..."
type: reference
keywords:
  - completion
  - configure
...
## openclaw completion Command (Shell Completion)
...
> **Note:** `openclaw config` without a subcommand opens the same wizard. Use `openclaw config get|set|unset` for non-interactive edits.

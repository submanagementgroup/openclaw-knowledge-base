---
domain: cli
topic: "Memory CLI: openclaw memory search, list, and View Commands"
type: reference
keywords:
  - openclaw memory
  - memory CLI
...
related:
  ...
  - cli/cli-overview
source: cli/memory.md
---

The `openclaw memory` command manages agent memory: search, list, and view memory files.
...
- Tune scheduled sweep cadence with `dreaming.frequency`. Deep promotion p

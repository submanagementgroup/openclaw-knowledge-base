---
domain: cli
topic: "CLI: openclaw migrate Commands"
type: procedure
keywords:
  - openclaw migrate
  - migration
...
> **Note:** For user-facing walkthroughs, see [Migrating from Claude](/install/migrating-claude) and [Migrating from Hermes](/install/migrating-hermes). The [migration hub](/install/migrating) lists all paths.
...
> **Note:** For a user-facing walkthrough, see [Migrating from Claude](/install/migrating-claude).

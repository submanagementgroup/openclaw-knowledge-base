---
domain: web-ui
topic: "Control UI: Browser Dashboard for Chat, Config, Sessions, and Logs"
type: procedure
keywords:
  - Control UI
  - dashboard
...
The OpenClaw Control UI is a browser dashboard for chat, configuration, session management, and logs. Access it at http://127.0.0.1:18789 after starting the Gateway.

## Opening the Control UI

```bash
openclaw dashboard   # open in default browser
# or navigate to:
# http://127.0.0.1:18789
```
...
## What it can do (today)
    ...
    - Webhook mode uses `delivery.mode = "webhook"` with `delive

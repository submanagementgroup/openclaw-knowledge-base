---
domain: reference
topic: "Docs Authoring Guide: Mintlify Link Rules, i18n Policy, and Documentation Structure"
type: reference
keywords:
  - docs authoring
  - Mintlify
...
Documentation authoring guide for the OpenClaw docs: Mintlify link rules, i18n policy, and docs structure.

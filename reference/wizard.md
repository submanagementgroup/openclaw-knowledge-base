---
domain: reference
topic: "Configuration Wizard Reference"
type: reference
keywords:
  - wizard
...
> **Note:** If no GUI is detected, onboarding prints SSH port-forward instructions for the Control UI instead of opening a browser.

---
domain: reference
topic: "AGENTS.md Default Content: Default Agent Instructions for OpenClaw"
type: reference
keywords:
  - AGENTS.md default
...
source: reference/AGENTS.default.md
---

Default AGENTS.md content for OpenClaw agent workspaces.

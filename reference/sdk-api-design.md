---
domain: reference
topic: "SDK API Design: Design Principles, Conventions, and Architecture Decisions"
type: reference
keywords:
  - SDK API design
  - API design
...
related:
  ...
  - concepts/sdk-overview
source: reference/openclaw-sdk-api-design.md
---

OpenClaw SDK API design document: design principles and API conventions.
...
- whether a tool is hidden, readonly, write capable,

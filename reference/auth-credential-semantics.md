---
domain: reference
topic: "Auth Credential Semantics: Profile Resolution, Eligibility, and Routing Rules"
type: reference
keywords:
  - auth credentials
...
related:
  ...
  - gateway/secrets
source: auth-credential-semantics.md
---

Canonical credential eligibility and resolution semantics for auth profiles in OpenClaw.

...
> **Note:** **Looking for a walkthrough?** See [Channel Plugins](/plugins/sdk-channel-plugins)
...
- make sure those descriptors cover every top-level command root exposed by the
  registrar
- keep descriptor command names to letters, number
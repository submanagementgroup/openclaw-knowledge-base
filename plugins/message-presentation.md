---
domain: plugins
topic: "Message Presentation Plugin: Control UI Display and Rich Message Rendering"
type: reference
keywords:
...
source: plugins/message-presentation.md
---

Message presentation plugin: controls how messages are displayed in the Control UI and other interfaces.

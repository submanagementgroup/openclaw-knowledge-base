...
keywords:
  ...
  - codex-cli plugin
  - CLI agent
source: plugins/cli-backend-plugins.md
---
...
> **Note:** If the upstream service exposes a normal HTTP model API, write a
...
`command` when the binary is outsi
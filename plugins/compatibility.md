---
domain: plugins
topic: "Plugin Compatibility: SDK Version Support Matrix and Version Requirements"
type: reference
keywords:
...
source: plugins/compatibility.md
---

Plugin compatibility matrix: which SDK versions work with which OpenClaw versions.

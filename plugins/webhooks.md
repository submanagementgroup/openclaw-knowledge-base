---
domain: plugins
topic: "Webhooks Plugin: Inbound Webhook Endpoints for Triggering Agent Runs"
type: procedure
keywords:
  - webhooks
  - inbound webhooks
...
source: plugins/webhooks.md
---

Webhooks plugin for OpenClaw: expose inbound webhook endpoints that trigger agent runs.

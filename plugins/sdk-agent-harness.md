---
domain: plugins
topic: "SDK Agent Harness: Building Agent Runtime Adapters and Harness Plugins"
type: reference
keywords:
  - agent harness
  - harness plugin
...
source: plugins/sdk-agent-harness.md
---

Agent harness plugins adapt the OpenClaw agent loop to different execution environments (e.g., Codex harness).
...
By default, OpenClaw runs embedded agents with `ag

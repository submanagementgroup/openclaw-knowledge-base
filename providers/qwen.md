...
> **Note:** **Qwen OAuth has been removed.** The free-tier OAuth integration
...
> **Note:** If you want `qwen3.6-plus`, prefer the **Standard (pay-as-you-go)** endpoint.
...
> **Note:** Legacy `modelstudio-*` auth-choice ids and `modelstudio/...` model refs still
...
> **Note:** **Manage keys:** [home.qwencloud.com/api-keys](https://home.qwencloud.com/api-keys) |
...
> **Note:** Availability can still vary by endpoint and billing plan even when a model is
...
**Alibaba (ModelStudio):** Legacy ModelStudio provider and migration notes.

---
domain: providers
topic: "Claude Max API Proxy Provider"
type: integration
keywords:
  - Claude Max
  - api proxy
...
> **Note:** This path is technical compatibility only. Anthropic has blocked some subscription
...
> **Note:** For native Anthropic integration with Claude CLI or API keys, see [Anthropic provider](/providers/anthropic). For OpenAI/Codex subscriptions, see [OpenAI provider](/providers/openai).

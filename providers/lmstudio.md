---
domain: providers
topic: "LM Studio Provider: Setup, Configuration, and Model Reference"
type: procedure
keywords:
  - LM Studio
  - lmstudio provider
...
source: providers/lmstudio.md
---

LM Studio provider setup, configuration, and model reference for OpenClaw.

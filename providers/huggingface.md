---
domain: providers
topic: "HuggingFace Provider: Setup, Configuration, and Model Reference"
type: procedure
keywords:
  - HuggingFace
...
HuggingFace provider setup, configuration, and model reference for OpenClaw.

...
> **Note:** Anonymized models are **not** fully private. Venice strips metadata before forwarding, but the underlying provider (OpenAI, Anthropic, Google, xAI) still processes the request. Choose **Private** models when full privacy is required.
...
> **Note:** Use the table below to pick the right model for your use case.
...
**Venice AI:** Venice AI homepage and account signup.
  

**API documentation:** Venice API reference and developer docs.
  

**Pricing:** Current Venice credit rates and plans.

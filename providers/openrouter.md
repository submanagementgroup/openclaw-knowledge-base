...
> **Note:** Model refs follow the pattern `openrouter/<provider>/<model>`. For the full list of
...
> **Note:** If you repoint the OpenRouter provider at some other proxy or base URL, OpenClaw

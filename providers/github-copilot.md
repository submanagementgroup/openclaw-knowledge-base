...
Use the **Copilot Proxy** VS Code extension as a local bridge. OpenClaw talks to
    ...
    > **Note:** Choose this when you already run Copilot Proxy in VS Code or need to route
...
The login stores a GitHub token in the auth profile store and exchanges it
    ...
    token manually.
  > **Note:** The device-login command requires an interactive TTY. Use non-interactive

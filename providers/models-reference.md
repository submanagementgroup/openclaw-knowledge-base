---
domain: providers
topic: "Models Reference Provider: Setup, Configuration, and Model Reference"
type: procedure
keywords:
  - Models Reference
  - models-reference provider
  - AI provider
  - model config
  - API key
  - models reference
...
source: providers/models.md
---

Models Reference provider setup, configuration, and model reference for OpenClaw.

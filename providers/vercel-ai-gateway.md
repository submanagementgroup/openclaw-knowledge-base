---
domain: providers
topic: "Vercel AI Gateway Provider: Setup, Configuration, and Model Reference"
type: procedure
keywords:
  - Vercel AI Gateway
...
Vercel AI Gateway provider setup, configuration, and model reference for OpenClaw.

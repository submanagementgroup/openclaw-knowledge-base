...
> **Note:** If you pass `--nvidia-api-key` instead of the env var, the value lands in shell
...
Some NVIDIA-hosted custom models can take longer than the default model idle
  ...
  > **Note:** NVIDIA models are currently free to use. Check

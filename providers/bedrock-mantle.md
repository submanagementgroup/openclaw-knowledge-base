---
domain: providers
topic: "Amazon Bedrock Mantle Provider"
type: integration
keywords:
  - Bedrock Mantle
  - mantle
  - bedrock mantle
source: providers/bedrock-mantle.md
---
...
> **Note:** When `AWS_BEARER_TOKEN_BEDROCK` is not set, OpenClaw mints the bearer token for you from the AWS default credential chain, including shared credentials/config profiles, SSO, web identity, and instance or task roles.
...
> **Note:** The bearer token is the same `AWS_BEARER_TOKEN_BEDROCK` used by the standard [Amazon Bedrock](/providers/bedrock) provider.

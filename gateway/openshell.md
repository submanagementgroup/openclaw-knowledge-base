---
domain: gateway
topic: "OpenShell Gateway Integration"
type: integration
keywords:
  - openshell
  - shell access
...
> **Note:** If you edit files on the host outside OpenClaw after the initial seed, the remote sandbox does **not** see those changes. Use `openclaw sandbox recreate` to re-seed.
...
For `mirror` mode, recreate mainly resets the 
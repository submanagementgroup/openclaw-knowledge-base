---
domain: gateway
topic: "Tool Execution Sandboxing"
type: concept
keywords:
  - sandboxing
  - sandbox
...
> **Note:** **Docker-out-of-Docker (DooD) constraints**
...
Use `plugins.entries.openshell.config.mode: "mirror"` when you want the **local workspace to stay canonical**.
    ...
    - you want the OpenShell sandbox to behave as much like the
---
domain: channels
topic: "Broadcast Groups"
type: integration
keywords:
  - broadcast
  - broadcast groups
  - broadcast channel
source: channels/broadcast-groups.md
---

> **Note:** **Status:** Experimental. Added in 2026.1.9.
...
> **Note:** **Precedence:** `broadcast` takes priority over `bindings`.

---
domain: channels
topic: "Google Chat Channel: App Setup, Access Control, and Spaces"
type: procedure
keywords:
  - Google Chat
  - Google Chat bot
...
related:
  - channels/slack
  - channels/msteams
source: channels/googlechat.md
---

Google Chat channel for OpenClaw. Connects as a Google Chat app/bot.
...
- Deprecated: `users/<email>` is treated as a user id, not an email allow

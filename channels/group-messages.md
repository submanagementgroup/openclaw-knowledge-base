---
domain: channels
topic: "Group Message Handling"
type: integration
keywords:
  - group messages
  - group chat
  - message routing
source: channels/group-messages.md
---
...
> **Note:** `agents.list[].groupChat.mentionPatterns` is also used by Telegram, Discord, Slack, and iMessage. For multi-agent setups, set it per agent, or use `messages.groupChat.mentionPatterns` as a global fallback.

---
domain: channels
topic: "Synology Chat Channel: Setup, Access Control, and Configuration"
type: procedure
keywords:
  - Synology Chat
  - NAS chat
...
source: channels/synology-chat.md
---

Synology Chat channel setup and configuration for OpenClaw.

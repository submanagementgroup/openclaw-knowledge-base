---
domain: channels
topic: "Channel Routing: Multi-Agent Message Routing, Binding Rules, and Session Isolation"
type: concept
keywords:
  - channel routing
  - message routing
...
source: channels/channel-routing.md
---

Channel routing determines which agent handles messages from which channel or sender. Configure routing rules to direct different users or channels to different agents.
...
`sessions.json` file. Symlinks and out-of-root p

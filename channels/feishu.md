---
domain: channels
topic: "Feishu / Lark Channel Setup"
type: procedure
keywords:
  - Feishu
  - Lark
...
> **Note:** Requires OpenClaw 2026.4.25 or above. Run `openclaw --version` to check. Upgrade with `openclaw update`.
...
> **Note:** Feishu/Lark does not support native slash-command menus, so send these as plain text messages.

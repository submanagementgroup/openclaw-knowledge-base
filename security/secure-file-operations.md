---
domain: security
topic: "Secure File Operations: fs-safe Library, Python Helper, and Plugin File Access Guidance"
type: reference
keywords:
  - fs-safe
  ...
  - plugin file access
  - FS_SAFE_PYTHON
source: gateway/security/secure-file-operations.md
related:
...
Configure the Python helper via environment variable:

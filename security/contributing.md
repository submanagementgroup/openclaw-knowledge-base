---
domain: security
topic: "Contributing to the Threat Model: Format, Structure, and Submission Process"
type: reference
keywords:
  - contributing
...
source: security/CONTRIBUTING-THREAT-MODEL.md
---

How to contribute to the OpenClaw threat model: format, structure, and submission process.

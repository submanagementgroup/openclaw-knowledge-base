...
> **Note:** Fastest first chat: open the Control UI (no channel setup needed). Run
...
> **Note:** CLI onboarding includes a web search step where you can pick a provider
...
> **Note:** Re-running onboarding does **not** wipe anything unless you explicitly choose **Reset** (or pass `--reset`).

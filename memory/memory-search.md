---
domain: memory
topic: "Memory Search: Hybrid BM25 + Vector Retrieval"
type: reference
keywords:
  - memory search
  - memory_search
  ...
  - embeddings
  - memorySearch config
source: concepts/memory-search.md
---
...
> **Note:** Enable temporal decay if your agent has months of daily notes and stale
...
> **Note:** Enable MMR if `memory_search` keeps returning near-duplicate snippets from

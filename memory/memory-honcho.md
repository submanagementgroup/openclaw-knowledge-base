...
> **Note:** Honcho can run entirely locally (self-hosted) or via the managed API at
...
> **Note:** Migration is non-destructive -- files are uploaded to Honcho. Originals are

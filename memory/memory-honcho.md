---
domain: memory
topic: "Honcho Memory Backend: Cloud-Based Persistent Memory for OpenClaw Agents"
type: procedure
keywords:
  - Honcho
  - cloud memory
...
related:
  ...
  - memory/memory-qmd
source: concepts/memory-honcho.md
---

Honcho is an optional cloud-based memory backend for OpenClaw. It provides persistent, user-scoped memory across sessions using the Honcho platform.

---
domain: tools
topic: "Thinking Tool: Extended Reasoning, Thinking Levels, and Reasoning Configuration"
type: procedure
keywords:
  - thinking
  - reasoning
...
source: tools/thinking.md
---

The thinking tool enables extended reasoning in the agent. Supported by models with reasoning capabilities (Claude, o3, etc.).

---
domain: tools
topic: "Perplexity Search Setup: API Key, Sonar Model, and OpenRouter Compatibility"
type: procedure
keywords:
  - Perplexity
  - PERPLEXITY_API_KEY
...
Perplexity Search API and Sonar compatibility for the web_search tool in OpenClaw.
